...
import { ERC20Upgradeable, ERC20Upgradeable__factory } from '../typechain';

export class EtherERC20Client implements ERC20Client {
  private _erc20: ERC20Upgradeable | undefined;
  ...
  public async connect(
    ...
    this._erc20 = ERC20Upgradeable__factory.connect(address, provider);
